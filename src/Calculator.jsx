        ...
        <div className='container'>
            <div className="row">
                <div className="col-12">
                    <h1 className='display-5 fw-bold text-center'>CALCULATOR</h1>
                    <hr />
                </div>
            </div>
            ...
            <div className="row justify-content-center">
                <div className="col-md-4">
                   <div class="card border-primary mb-3">
                     ...
                     <input type="text" className='form-control-lg form-control mb-4 text-center bg-light fs-4 text-primary shadow' value={val} />
                     <div className="row">
                        <div className="col-3">
                     ...
                     <div className="row mt-3">
                        <div className="col-3">
                            <button className='btn btn-light text-primary shadow p-4 fs-4' value='del' onClick={handleAllClear}> del</button>
                        </div>
                        <div className="col-3">
